...
6. 成功したら、プルリクエストにバージョン上げのコミットが含まれていることを確認してから、プルリクエストをマージします。(先程のスクリプト内でバージョン上げ, コミット, タグとコミットのpushは自動で行われます)
7. 新しいタグが生成されれていることを確認し、https://github.com/WWAWing/WWAWing/releases で新しいリリースを作成してください。
