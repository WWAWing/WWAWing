...
import {
    ...
    StatusKind, StatusSolutionKind, UserVarNameListRequestErrorKind, ScoreOptions, TriggerParts,
} from "./wwa_data";
...
import { ParsedMessage, isEmptyMessageTree, Node, Junction, Page, generatePagesByRawMessage } from "./wwa_messsage";
...
export class WWA {
    ...
    public generatePageAndReserveExecution(
        ...
        const generatedPage = generatePagesByRawMessage(message, partsID, partsType, partsPosition, isSystemMessage, showChoice, scoreOption);
