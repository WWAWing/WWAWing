...
module wwa_data {
    ...
    */
    ...
    export class Position {
        ...
        public constructor(wwa: wwa_main.WWA, x: number, y: number, offsetX: number = 0, offsetY: number = 0) {
            this._wwa = wwa;
            if (this._wwa === void 0) {
    ...
    export var dirToKey = [wwa_input.KeyCode.KEY_LEFT, wwa_input.KeyCode.KEY_RIGHT, wwa_input.KeyCode.KEY_DOWN, wwa_input.KeyCode.KEY_UP];
...
//        USE_ITEM,
    ...
    export class WWAConsts {
        static VERSION_WWAJS: string = "W3.13d-dev01";
